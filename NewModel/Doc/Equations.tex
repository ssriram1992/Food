...
\Max \quad &: \quad  \sum_{y\in\Y} \DiscFact \left \{ \sum_{f\in \C}\left (
	\widehat{\piF}\widehat{\QFf} - \CsF\AF - \frac{1}{2}\CsChg \left( \AF - \AF[(y-1)nf] \right) 
 \right)^2\right .\nonumber\\
...
\widehat{\QFf} \quad &\leq \quad \widehat{\Yld}\AF &(\db)\\
\intertext{Linking yield with climate yield factor and any other enhancements:}
\Yld \quad &= \quad \aInCYF\CYF\widehat{\piF}^{\elasticity}\left( 1+\YieldBoost \right) \\
